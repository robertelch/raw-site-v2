  ...
  <div class="fixed w-full top-0 left-0 p-4 bg-gradient-to-b from-black/75 via-black/50 to-transparent">
    <div class="flex justify-between">
      ...
      <div class="flex sm:space-x-2 text-white">
        ...
        <Button href="https://discord.gg/vtCAhcWG4z" target="_blank" class="rounded-full sm:rounded-md" type="secondary">
          <div class="flex space-x-2">
            <svg class="my-auto w-5 h-5" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
